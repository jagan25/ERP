...
<title>PAYMENT</title>
<?php include_once("billingconn.php") ;
...
$_SESSION['quantity']=$quantity;
	...
	//$sql="SELECT count(*) FROM product WHERE(prodid='".$uname."' and password='".$pass."' and id='".$id1."')";
	 echo "<table border='2' bgcolor='blue' cellspacing='2' cellpadding='2'>
...
<body>
<div id="forms">
<form name="pay" action="paid.php">

Amount paid<input type="text" name="Amount_Paid" id="p">
